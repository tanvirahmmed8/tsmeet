...
export function normalizeCalendarSettings(settings: CalendarSettings | string | null | undefined): Required<CalendarSettings> & CalendarSettings {
  ...
  return {
    ...
    roundRobinMembers,
    slotDurationMinutes: Number(parsed.slotDurationMinutes || 30),
    slotIntervalMinutes: Number(parsed.slotIntervalMinutes || parsed.slotDurationMinutes || 30),
    bufferBeforeMinutes: Number(parsed.bufferBeforeMinutes || 0),
    bookingWindowDays: Number(parsed.bookingWindowDays || 30),
    dailySlotLimit: Number(parsed.dailySlotLimit || 0),
